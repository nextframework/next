...
/**
 * HTTP Response Header Field Class: X-Forwarded-Proto | HTTP\Headers\Response\XForwardedProto.php
 *
...
/**
 * Response Header Field Validation Class: 'X-Forwarded-Proto'
 */
use Next\Validation\HTTP\Headers\Response\XForwardedProto as Validator;

/**
 * Response Header Field: 'X-Forwarded-Proto'
 *
 * @package    Next\HTTP
 *
 * @uses       Next\Validation\Validator
 *             Next\HTTP\Headers\Field
 *             Next\Validation\HTTP\Headers\XForwardedProto
 */
class XForwardedProto extends Field {
