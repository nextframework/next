...
/**
 * HTTP Response Header Field Class: Age | HTTP\Headers\Response\Age.php
 *
...
/**
 * Response Header Field Validation Class: 'Age'
 */
use Next\Validation\HTTP\Headers\Response\Age as Validator;

/**
 * Response Header Field: 'Age'
 *
 * @package    Next\HTTP
 *
 * @uses       Next\Validation\Validator
 *             Next\HTTP\Headers\Field
 *             Next\Validation\HTTP\Headers\Age
 */
