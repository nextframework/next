...
/**
 * HTTP Response Header Field Class: Server | HTTP\Headers\Response\Server.php
 *
...
/**
 * Response Header Field Validation Class: 'Server'
 */
use Next\Validation\HTTP\Headers\Response\Server as Validator;
 ...
 *             Next\Validation\HTTP\Headers\Server
 */
class Server extends Field {
