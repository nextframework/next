...
/**
 * HTTP Response Header Field Class: Link | HTTP\Headers\Response\Link.php
 *
...
/**
 * Response Header Field Validation Class: 'Link'
 */
use Next\Validation\HTTP\Headers\Response\Link as Validator;

/**
 * Response Header Field: 'Link'
 *
 * @package    Next\HTTP
 *
 * @uses       Next\Validation\Validator
 *             Next\HTTP\Headers\Field
 *             Next\Validation\HTTP\Headers\Link
 */
