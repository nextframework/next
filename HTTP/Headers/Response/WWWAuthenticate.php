...
/**
 * HTTP Response Header Field Class: WWW-Authenticate | HTTP\Headers\Response\WWWAuthenticate.php
 *
...
/**
 * Response Header Field Validation Class: 'WWW-Authenticate'
 */
use Next\Validation\HTTP\Headers\Response\WWWAuthenticate as Validator;

/**
 * Response Header Field: 'WWW-Authenticate'
 *
 * @package    Next\HTTP
 *
 * @uses       Next\Validation\Validator
 *             Next\HTTP\Headers\Field
 *             Next\Validation\HTTP\Headers\WWWAuthenticate
 */
class WWWAuthenticate extends Field {
