...
/**
 * HTTP Common Header Field Class: Date | HTTP\Headers\Common\Date.php
 *
...
/**
 * Common Header Field Validation Class: 'Date'
 */
use Next\Validation\HTTP\Headers\Common\Date as Validator;

/**
 * Common Header Field: 'Date'
 *
 * @package    Next\HTTP
 *
 * @uses       Next\Validation\Validator
 *             Next\HTTP\Headers\Field
 *             Next\Validation\HTTP\Headers\Date
 */
class Date extends Field {
    ...
    public function setOptions() : array {
        return [ 'name' => 'Date', 'preserveWhitespace' => TRUE ];
    }
}
