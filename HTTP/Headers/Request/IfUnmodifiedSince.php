...
/**
 * Request Header Field Validation Class: 'If-Unmodified-Since'
 */
use Next\Validation\HTTP\Headers\Request\IfUnmodifiedSince as Validator;

/**
 * Request Header Field: 'If-Unmodified-Since'
 *
 * @package    Next\HTTP
 *
 * @uses       Next\Validation\Validator
 *             Next\HTTP\Headers\Field
 *             Next\Validation\HTTP\Headers\IfUnmodifiedSince
 */
class IfUnmodifiedSince extends Field {
