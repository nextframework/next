...
/**
 * HTTP Request Header Field Class: User-Agent | HTTP\Headers\Request\User-Agent.php
 *
...
/**
 * Request Header Field Validation Class: 'User-Agent'
 */
use Next\Validation\HTTP\Headers\Request\UserAgent as Validator;

/**
 * Request Header Field: 'User-Agent'
 *
 * @package    Next\HTTP
 *
 * @uses       Next\Validation\Validator
 *             Next\HTTP\Headers\Field
 *             Next\Validation\HTTP\Headers\UserAgent
 */
