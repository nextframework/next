...
use Next\Validate\HTTP\Headers\Request\IfModifiedSince;    # Request If-Modified-Since Header Field Validator Class
...
class IfModifiedSince extends AbstractField implements Request {
    ...
    protected function getValidator( $value ) {
        return new IfModifiedSince( array( 'value' => $value ) );
    }
