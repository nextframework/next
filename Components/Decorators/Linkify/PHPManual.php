...
/**
 * PHP Manual Linkify Decorator | Components\Decorators\Linkify\NextAPI.php
 *
...
class PHPManual extends Object implements Decorator, Linkify {
    ...
    const PHP_MANUAL_LINK_FORMAT = '<a href="%s/%s">%s()</a>';

    /**
     * List of PHP Functions and/or resources with hotlinks
     * on PHP Manual (i.e. http://www.php.net/{function})
     *
     * @var array
     *
     * @see http://www.php.net/get_defined_functions()
     */
    const PHP_FUNCTIONS = [
      'zend_version',
      'func_num_args',
      ...
      // Additional, manually added, working entries
        ...
        return preg_replace_callback(
            ...
            function( $matches ) {
                ...
                if( empty( $matches['sro'] ) && ! empty( $matches['function'] ) ) {
                    ...
                    if( in_array( $expression, self::PHP_FUNCTIONS ) ) {

                        return sprintf(

                            self::PHP_MANUAL_LINK_FORMAT,

                            self::PHP_MANUAL_URL, $expression, $expression
                        );
                    }
