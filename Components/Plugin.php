...
abstract class Plugin extends Object {
    ...
    protected $parameters = [
         ...
         * \Next\Components\Plugin::$routesBaseURI for the same reason
         * as any other route
         *
     ...
     * @see \Next\Components\Events\Handler::getHandledResults()
     */
    private function addDefaultEventListeners() {

        $this -> eventHandler -> addListener(

            'success', new Listener( function( Event $event, $message ) {
                return $message;
            })
        );
        ...
        $this -> eventHandler -> addListener(
            ...
            'warning', new Listener( function( Event $event, $message ) {
                return $message;
            })
        );
        ...
        $this -> eventHandler -> addListener(
            ...
            'info', new Listener( function( Event $event, $message ) {
                return $message;
            })
        );
        ...
        $this -> eventHandler -> addListener(
            ...
            'error', new Listener( function( Event $event, $message ) {
