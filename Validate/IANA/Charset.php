...
class Charset extends Object implements Validator {
    ...
    const CHARSETS_LIST = [
        ...
        'ISO_8859-7:1987' => [
            'iso-ir-126', 'ISO_8859-7', 'ISO-8859-7', 'ELOT_928',
        ...
        'ATS-SEFI' => [ 'iso-ir-8-1', 'csNATSSEFI' ],

        'ATS-SEFI-ADD' => [ 'iso-ir-8-2', 'csNATSSEFIADD' ],

        'ATS-DANO' => [ 'iso-ir-9-1', 'csNATSDANO' ],

        'ATS-DANO-ADD' => [ 'iso-ir-9-2', 'csNATSDANOADD' ],

        'SEN_850200_B' => [
            'iso-ir-10', 'FI', 'ISO646-FI', 'ISO646-SE', 'se',
            'csISO10Swedish'
        ],

        'KS_C_5601-1987' => [
            'iso-ir-149', 'KS_C_5601-1989', 'KSC_5601', 'korean',
            'csKSC56011987'
        ],
        ...
        'JIS_C6229-1984-b' => [
            'iso-ir-92', 'ISO646-JP-OCR-B', 'jp-ocr-b',
        ...
        'ISO-8859-16' => [
            'iso-ir-226', 'ISO_8859-16:2001', 'ISO_8859-16',
            'latin10', 'l10'
        ],
        ...
        'IBM01142' => [
            'CCSID01142', 'CP01142', 'ebcdic-dk-277+euro',
            'ebcdic-no-277+euro'
        ],

        'IBM01143' => [
            'CCSID01143', 'CP01143', 'ebcdic-fi-278+euro',
            'ebcdic-se-278+euro'
        ],
    ...
    public function validate() {
        ...
        $source = array_merge(
            array_keys( self::$CHARSETS_LIST ), self::$CHARSETS_LIST
        );
